...
def existing():
    if request.method == 'POST':
        if 'user_id' in request.form and 'user_name' in request.form and 'delete_user' not in request.form:
            ...
            # Delete user and all associated data
            delete_user(user_id_hash)
            
            return render_template('existing.html', success_message="User account and all associated data have been deleted successfully.")
